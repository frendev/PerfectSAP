...
function Modal(props: any) {
  ...
  return (
    <div>
      {showModal && (
        <div>
          <div className="text-xl top-0 left-0 bottom-0 right-0 fixed px-4 flex items-center justify-center z-50">
            <div className="bg-black opacity-50 w-full h-full absolute z-10 inset-0"></div>
